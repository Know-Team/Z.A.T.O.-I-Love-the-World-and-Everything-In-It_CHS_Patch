...
init -501 screen say(who, what):
    ...
    if not renpy.variant("small"):
        add SideImage() xalign 0.87 yalign 0.96
...
init -501 screen main_menu():
    ...
    add Snow("images/sprites/snow/snow2.png")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("简体中文") text_font "Plix-ExtraLight.otf" action Language("SimplifiedChinese")
...
init -1 python:
    def show_history_on_scroll():
        ui.add(renpy.Keymap(rollback=ShowMenu('history')))

init -1 python:
    config.overlay_functions.append(show_history_on_scroll)
...
init -501 screen mouse_help():
    ...
    hbox:
        label _("{b}Left Click")
        text _("Advances dialogue and activates the interface.")

    hbox:
        label _("{b}Middle Click")
        text _("Hides the user interface.")

    hbox:
        label _("{b}Right Click")
        text _("Accesses the game menu.")

    hbox:
        label _("{b}Mouse Wheel Up")
        text _("Shows the log.")

    hbox:
        label _("{b}Mouse Wheel Down")
        text _("Rolls forward to later dialogue.")
...
init -501 screen gamepad_help():
    ...
    hbox:
        label _("{b}Right Trigger\nA/Bottom Button")
        text _("Advances dialogue and activates the interface.")

    hbox:
        label _("{b}Left Trigger\nLeft Shoulder")
        text _("Shows the log.")

    hbox:
        label _("{b}Right Shoulder")
        text _("Rolls forward to later dialogue.")


    hbox:
        label _("{b}D-Pad, Sticks")
        text _("Navigate the interface.")

    hbox:
        label _("{b}Start, Guide")
        text _("Accesses the game menu.")

    hbox:
        label _("{b}Y/Top Button")
        text _("Hides the user interface.")
